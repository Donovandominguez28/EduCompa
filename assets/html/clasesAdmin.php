...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table table-striped table-hover">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='9'>No hay clases registradas.</td></tr>";
            }
            $conn->close();
            ?>
            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" method="POST" enctype="multipart/form-data" action="../php/agregarClasesAdmin.php">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="addMateria" name="materia" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="addNombreProfesor" name="nombreProfesor" required>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" enctype="multipart/form-data" action="../php/editarClase.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editMateria" name="materia" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editNombreProfesor" name="nombreProfesor" required>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="deleteForm" method="POST" action="../php/eliminarClase.php">
  ...
  <script src="../js/scriptAdmin.js"></script>
    ...
    editModal.addEventListener('show.bs.modal', function (event) {
        ...
        var modalBodyIdClase = editModal.querySelector('.modal-body #editIdClase')
        var modalBodyTitulo = editModal.querySelector('.modal-body #editTitulo')
        var modalBodyMateria = editModal.querySelector('.modal-body #editMateria')
        var modalBodyDescripcion = editModal.querySelector('.modal-body #editDescripcion')
        var modalBodyNombreProfesor = editModal.querySelector('.modal-body #editNombreProfesor')
        var modalBodyCarnet7 = editModal.querySelector('.modal-body #editCarnet7')

        modalTitle.textContent = 'Editar Clase ' + titulo
        modalBodyIdClase.value = idClase
        modalBodyTitulo.value = titulo
        modalBodyMateria.value = materia
        modalBodyDescripcion.value = descripcion
        modalBodyNombreProfesor.value = nombreProfesor
        modalBodyCarnet7.value = carnet7
    })
    ...
    confirmDeleteModal.addEventListener('show.bs.modal', function (event) {
        ...
        var modalBodyIdClase = confirmDeleteModal.querySelector('.modal-body #deleteIdClase')
        modalBodyIdClase.value = idClase
    })
    </script>
</body>
