...
?>
<body>
    <a class="btnS" href="../html/juegos.php"><-- Regresar</a>
  <div class="container">
    <header>
    ...
    <div class="grid"></div>
    <footer>Presione una tecla de flecha o espacio para comenzar!
      <div>¿Estás listo para el modo difícil? Presiona H
      </div>
    </footer>
  </div>
