...
<main>
    ...
    <form id="editarPerfil" action="../php/editarPerfil.php" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" id="seccion" name="seccion" value="<?php echo htmlspecialchars($estudiante['seccion']); ?>" required>
        </div>
        <div>
            <label for="añoBachi">Año Bachillerato:</label>
            <input type="number" id="añoBachi" name="añoBachi" value="<?php echo htmlspecialchars($estudiante['añoBachi']); ?>" required>
        </div>
        <div>
            <label for="especialidad">Especialidad:</label>
            <input type="text" id="especialidad" name="especialidad" value="<?php echo htmlspecialchars($estudiante['especialidad']); ?>" required>
        </div>
        <div>
