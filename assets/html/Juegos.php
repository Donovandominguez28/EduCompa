    ...
    <article>
      ...
      <section class="section section-divider white cta reveal" style="background-image: url('../images/fondoAzul.jpg')">
        ...
        <div class="cardj reveal">
          <img src="../images/pong3.jpg" alt="Juego de Ajedrez">
          <div>
    <h2>Pong Clásico</h2>
    <h3>Tipo: Juego de Arcade</h3>
    <p>
        Disfruta del clásico juego de Pong y desafía a tus amigos en este emocionante juego de arcade. Perfecto para todas las edades y niveles de habilidad.
    </p>
    <a href="../html/pingPong.php">¡Juega ahora!</a>
</div>
        ...
        <div class="cardj reveal">
          <img src="../images/snake3.jpg" alt="Adivina la Letra">
          <div>
    <h2>Snake Clásico</h2>
    <h3>Tipo: Juego de Arcade</h3>
    <p>
        Disfruta del clásico juego de Snake y desafía tus reflejos y habilidades. Perfecto para todos los amantes de los juegos de arcade retro.
    </p>
    <a href="../html/snake.php">¡Juega ahora!</a>
</div>
