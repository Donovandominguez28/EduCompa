        ...
        <div class="containerform">
            <div class="cardform">
                ...
                <form action="../php/agregar_contenidoBanner.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="inputBox1">
                        <input type="text" name="descripcionBanner" required>
                        <span>Descripción del Banner</span>
                    </div>
                    <div class="inputBox1">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Descripción del Banner</th>
            ...
            if ($result_contenido === false) {
                die('Error en la consulta SQL: ' . $conn->error);
            }
            if ($result_contenido->num_rows > 0) {
                while ($row_contenido = $result_contenido->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>{$row_contenido['idBanner']}</td>";
                    echo "<td>{$row_contenido['materia']}</td>";
                    echo "<td>{$row_contenido['tituloBanner']}</td>";
                    echo "<td>{$row_contenido['descripcionBanner']}</td>";
                    echo "<td><img src='data:image/jpeg;base64," . base64_encode($row_contenido['banner']) . "' alt='Banner' width='50'></td>";
                    echo "<td><a href='../html/editarContenido.php?idBanner={$row_contenido['idBanner']}' class='edit-button'>
                    ...
                    echo "<td><a href='../php/eliminar_contenido.php?idBanner={$row_contenido['idBanner']}' class='delete-button'>
