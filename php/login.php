...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    verificarUsuario($conn, $email, $contrasena, "administrador", "idAdmin", "contrasena", "../html/admin.php");

    // Verificar profesores
    verificarUsuario($conn, $email, $contrasena, "profesor", "idProfesor", "contrasena", "../html/profesor.php");
