...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['multimedia']['size'] > 0) {
        ...
        $sql = "UPDATE contenidoClases SET idClase1 = '$idClase1', contenido = '$contenido', multimedia = '$multimedia', link = '$link' WHERE idContenido = $idContenido";
    } else {
        // Si no se envió un nuevo archivo multimedia, actualizar solo los otros campos
        $sql = "UPDATE contenidoClases SET idClase1 = '$idClase1', contenido = '$contenido', link = '$link' WHERE idContenido = $idContenido";
    }
